   ...
   // PDFView pdfView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* pdfView=findViewById(R.id.pdfview);
        ...
        actionBar.setTitle("CLAT 2012");
        actionBar.setDisplayHomeAsUpEnabled(true);

        new Retrivepdf().execute("https://static-collegedunia.com/public/college_data/images/entrance/sample_paper/1477559785CLAT%202012.pdf");
*/
    }
