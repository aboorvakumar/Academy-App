...
public class Pdf3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("CLAT 2011");
        actionBar.setDisplayHomeAsUpEnabled(true);

        new Retrivepdf().execute("https://static-collegedunia.com/public/college_data/images/entrance/sample_paper/1477559785CLAT%202011.pdf");
*/
    }
