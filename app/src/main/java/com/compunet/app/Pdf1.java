   ...
   // PDFView pdfView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* pdfView=findViewById(R.id.pdfview);
        ...
        actionBar.setTitle("CLAT 2009");
        actionBar.setDisplayHomeAsUpEnabled(true);

        new Retrivepdf().execute("https://static-collegedunia.com/public/college_data/images/entrance/sample_paper/1474884043SAMPLE%20PAPER%201.pdf");
*/
    }
